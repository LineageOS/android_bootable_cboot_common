...
static enum tegrabl_bmp_resolution get_optimal_bmp_resolution(
...
{
	enum tegrabl_blob_type btype = BLOB_NONE;
...
{
	enum tegrabl_bmp_resolution default_image_res = BMPRES_480P;
	enum tegrabl_bmp_resolution optimal_image_res;
	uint32_t i = 0;
